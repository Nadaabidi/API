...
app.post("/OwnerRegister", async (req:Request, resp:Response) => {
      try {
...
app.post("/OwnerLogin", async (req:Request, resp:Response) => {
      try {
            //check if the email/user exists or not
...
app.post("/Restaurants", async (req:Request, resp:Response) =>{
...
app.post("/FoodList", async (req:Request,resp:Response)=>{
      try{
...
app.get("/Restaurants", async (req:Request, resp:Response) => {
...
app.get("/FoodList/:item_name", async (req:Request,resp:Response)=>{
      try {
            const body: FoodList = req.body;
            console.log(body);
...
app.put("/FoodList/:item_id", async(req:Request,resp:Response)=>{
      try {
            const body: FoodList = req.body;
            console.log(body);
           await getConnection()
...
app.put("/Restaurant/:res_id", async(req:Request,resp:Response)=>{
      try {
            const body: Restaurant = req.body;
            console.log(body);
           await getConnection()
...
app.delete("/FoodList/:item_name",async (req:Request,resp:Response)=>{
      try {
            const body: FoodList = req.body;
            console.log(body);
            await getConnection()
...
app.delete("/Restaurant/:res_id",async (req:Request,resp:Response)=>{
      try {
            const body: Restaurant = req.body;
            console.log(body);
            await getConnection()
...
app.listen(process.env.PORT || 5050, () => console.log("App is Listening on PORT ",5050));
